...
class PatchUserData{
  ...
  static Future<Response> patchUserData({
    ...
    if (region != null) {
      if (region.state != null && region.state!.isNotEmpty) formData.fields.add(MapEntry('region_state', region.state!));
      if (region.city != null && region.city!.isNotEmpty) formData.fields.add(MapEntry('region_city', region.city!));
      if (region.district != null && region.district!.isNotEmpty) formData.fields.add(MapEntry('region_district', region.district!));
    }
